...
canvas = tk.Tk()
canvas.title("VisiPlayer")
canvas.geometry("600x600")
canvas.config(bg="black")

rootpath = "C:\\Users\orion\Downloads\musicvp"
pattern = "*.mp3"
...
next_img = tk.PhotoImage(file = "right.png")
...
listBox = tk.Listbox(canvas, fg="Yellow", bg="black", width=100, font='poppins')
